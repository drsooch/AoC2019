{-
THIS MODULE IS FOR DAY ONE ONLY.

This IntCode module has State only, the IMachine going forward will be using RWS.

-}
module IntCodeS (Program, IMachine, createIM, runMachine, injectValues, getMemValue, (!>)) where
